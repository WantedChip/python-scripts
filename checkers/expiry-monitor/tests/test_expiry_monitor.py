...
class TestExpiryMonitor(unittest.TestCase):
    ...
    def test_check_domain_expiry_errors(
        ...
        mock_get_ssl.return_value = {"expiry_date": None, "days_left": None, "error": "SSL handshake failure"}
        mock_get_domain.return_value = {
            "expiry_date": None,
            "days_left": None,
            "registrar": None,
    ...
    def test_print_report(self) -> None:
        ...
        reports = [
            {
                "domain": "healthy.com",
                "ssl": {"expiry_date": "2026-10-10", "status": "HEALTHY", "error": None},
                "domain_reg": {"expiry_date": "2027-11-11", "status": "HEALTHY", "error": None},
            },
            {
                "domain": "error.com",
                "ssl": {"expiry_date": None, "status": "ERROR", "error": "Connection error"},
                "domain_reg": {"expiry_date": None, "status": "ERROR", "error": "WHOIS error"},
            }
        ]
    ...
    def test_main_cli(self, mock_webhook: MagicMock, mock_check: MagicMock) -> None:
        ...
        mock_check.return_value = {
            "domain": "domain1.com",
            "ssl": {"expiry_date": "2026-10-10", "days_left": 40, "status": "HEALTHY", "error": None},
            "domain_reg": {"expiry_date": "2026-12-12", "days_left": 90, "status": "HEALTHY", "error": None},
        }
        ...
        mock_check.return_value = {
            "domain": "failed.com",
            "ssl": {"expiry_date": None, "days_left": None, "status": "ERROR", "error": "Handshake failed"},
            "domain_reg": {"expiry_date": "2026-07-10", "days_left": 1, "status": "CRITICAL", "error": None},
        }
        with self.assertRaises(SystemExit) as exc:
